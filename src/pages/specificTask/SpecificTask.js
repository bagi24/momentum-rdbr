    ...
    <>
      ...
      <div className='specificTask-content'>
        ...
        <div className='comment-section'>
          <input type='text' placeholder='დაამატე კომენტარი' className='comment-input' />
          <button className='comment-btn'>დაკომენტარება</button>
          <div className='comments'>
            ...
            <div className='comment'>
              ...
              <div className='comment-content'>
                <p className='username'>ემილია მორაგინი</p>
                <p className='text'>
